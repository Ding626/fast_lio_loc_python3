// ROS2 migration: use rclcpp and ROS2 message headers
...
enum LID_TYPE{AVIA = 1, VELO16, OUST64, ROBOSENSE16}; //{1, 2, 3, 4}
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // publishers are created by the owning node; store weak pointers as placeholders
